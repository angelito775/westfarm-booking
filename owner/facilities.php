            ...
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <div class="search-wrapper">
                        ...
                        <input type="text" placeholder="Search facilities, rooms, or inventory...">
                    </div>
                </div>
            ...
            <main class="main-content">
                <div class="section-card">
                    <div class="section-header">
                        <h3 class="section-title">Facilities & Rooms</h3>
                    </div>
                    <div class="section-body">
                        <p>This page is reserved for managing facility inventory, room details, availability, and maintenance status.</p>
                    </div>
                </div>
            </main>
