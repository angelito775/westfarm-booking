            ...
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <div class="search-wrapper">
                        ...
                        <input type="text" placeholder="Search payments, ledger entries, or revenue...">
                    </div>
                </div>
            ...
            <main class="main-content">
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <p>This page will show business finances, ledger entries, cash collected, and payment verification details.</p>
                    </div>
                </div>
            </main>
