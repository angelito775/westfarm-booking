            ...
            <header class="topbar">
                <div class="topbar-left">
                    ...
                    <div class="search-wrapper">
                        ...
                        <input type="text" placeholder="Search bookings, guests, or orders...">
                    </div>
                </div>
            ...
            <main class="main-content">
                <div class="section-card">
                    ...
                    <div class="section-body">
                        <p>This page will show all incoming booking requests, status updates, and reservation management tools for the owner.</p>
                    </div>
                </div>
            </main>
